...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <a class="navbar-brand ban" href="landPage.php">
        ...
        <div class="collapse navbar-collapse nav justify-content-end" id="navbarCollapse">
            ...
            <a  href = "login.php" type="button" class="btn  bt-ho">Login</a>
            </li>
            ...
            <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="land-image/school101.png.jpg" class="d-block w-100 h-w" alt="...">
                    </div>
                  
                    <div class="carousel-item">
                        <img src="land-image/school2.png" class="d-block w-100 h-w" alt="...">
                    </div>
                </div>
...
tenetur architecto esse ea aliquam alias aspernatur placeat! </p></pre>
            ...
            <div class=" cont-div2 ">
                <button type="button" class="btn btn-orange p-com-2">Join us!</button>
            </div>
        </div> 
