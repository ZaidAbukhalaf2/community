            ...
            <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="land-image//orange101.jpg" class="d-block w-100 h-w" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="land-image/orange2.png" class="d-block w-100 h-w" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="land-image/orange3.jpg" class="d-block w-100 h-w" alt="...">
                    </div>
                </div>
