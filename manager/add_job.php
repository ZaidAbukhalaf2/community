									...
									<div class="panel-body">
										<form method="post" name="chngpwd" class="form-horizontal" onSubmit="return valid();" enctype="multipart/form-data">
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control" name="jobname" value="<?php echo $job->name_job ;?>" id="brand" required>
												</div>
											</div>
                                            <div class="form-group">
												<label class="col-sm-2 control-label"> job_discribtion</label>
												<div class="col-sm-8">
													<input type="text" class="form-control" name="job_discribtion" id="sub_id" value="<?php echo $job->job_discribtion ;?>" required>
												</div>
											</div>
                                            <div class="form-group">
