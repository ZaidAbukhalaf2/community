...
<div class="wrapper">
    <div class="main-container">
        <div class="box-profile-information">
            ...
            <img src="<?php echo $amin->images_path_placeholder();?> "style="width: 100%;height: 250px;"> 
            <a class="edit" data-bs-toggle="modal" data-bs-target="#firstmodel" ><i class="fas fa-camera"></i></a>
            ...
            <div class="contant row px-lg-5">
                <div class="col-lg-2 col-md-3 col-sm-12">
                    <div class="profile-image">
                        <img src="<?=$amin->image_path_placeholder()?>" >
                        <a class="edit" data-bs-toggle="modal" data-bs-target="#secondmodel"  class="edit" ><i class="fas fa-camera"></i></a>
                    </div>
                </div>
                <div class="col-lg-10 col-md-9 col-sm-12 box-information-responce">
                    <strong class="name-user"><?php echo $amin->username;?></strong>
                    <span class="status"><i class="fas fa-check-circle"></i></span>
                    <a class="edit" data-bs-toggle="modal" data-bs-target="#thirdmodel"   class="edit"><i class="fas fa-pen"></i></a>

                    <div class="row mt-4 mb-3">
                        <div class="col-lg-7 col-md-7 col-sm-12">
                            <div class="row general-information">
                                <div class="col-lg-6 col-md-6 col-sm-12 mb-2"><i class="far fa-calendar"></i> <strong><?php echo $amin->birth_date;?></strong></div>
                                <div class="col-lg-6 col-md-6 col-sm-12 mb-2"><i class="fas fa-user"></i> <strong><?php echo $amin->type_user;?></strong></div>
                                <div class="col-12 mb-2"><i class="fab fa-linkedin-in"></i>  <?php echo $amin->linkedin;?></div>
                                <div class="col-12 mb-2"><i class="fas fa-envelope"></i>  <?php echo $amin->email;?></div>
                            </div>
                        </div>
                        <div class="col-lg-5 col-md-5 col-sm-12 sochal-media">
                            <a href="#" class="px-3"><i class="fas fa-phone-alt"></i> <?php echo $amin->phone_number;?>  </a>
                            <a href="#"><i class="fab fa-github"></i> <?php echo $amin->github;?></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="box-about-my mt-2">
            <div class="row responcive-row">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <p class="card-text3 "><?php echo $amin->about_me;?></p>
                </div>
            ...
            <div class="row responcive-row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 "> 
                  <div class="div-skills">
                    ...
                    <a class="add" data-bs-toggle="modal" data-bs-target="#lastModal" ><i class="far fa-edit"></i></a>
                    </div> 
                    <div class="skills-contant">
                <?php

                $result1= Skills::find_all();
                foreach($result1 as $rows){
                  if ($rows->user_id === $amin->id ) {

                ?>
                    <ul class="list-group list-items ">
                  <li class="shadow li-style "><?php echo $rows->skills_name;?></li>
                </ul>
                  <?php
                }};
                ?>
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            ...
            <form action="add_skills.php?id=<?php echo $amin->id?>"  method="post" enctype="multipart/form-data" >
                <div class="modal-body">
                    ...
                    <input type="text" name="skills_name" class="form-control small_div" value="<?php echo $skills->skills_name;?>" style="display: block;">
