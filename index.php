...
<div class="container home-container ">
  <div class="row">
     ...
     <!------------------------------------post card----------------------------------------------------->
        <div class="col-lg-6 col-sm-12 post-col">
        <!------------------------------------add post---------------------------------------------------->
        <div class="card">
            <div class="card-body">
            <h5 class="card-title comm-name"><?=$mess.' '.$amin->username?></h5>
      ...
      <!------------------------------------online users-------------------------------------------------->
        <div class="col-2 col-sm online-col right home-container">
        <div class="online_card">
        ...
        <div class="card mb-3" style="max-width: 275px;">
            ...
            <div class="col-md-8">
                ...
                <h6 class="card-title first-name-right"><?=$row8->first_name.' '.$row8->last_name?> <i class="fas fa-circle"></i></h6>
        ...
        <div class="row">
            <div class="card bg-dark text-white card4">
            <img src="image/job.png"  alt="..." height="200px" width="300px">
            <center>
